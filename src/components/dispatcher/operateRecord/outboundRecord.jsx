...
//引入枚举值
import { OUTBOUND_RECORD, OUTBOUND_RECORD_COLUMNS } from '../core/enumerate.js'
...
class OutboundRecord extends Component {
  constructor(props) {
    ...
    this.private = {
      dispatch,
      limit: 10,
      event: 'stock-order-done',                //入站(stock-order-stock-in)出站(stock-order-done)
  ...
  render() {
    ...
    const searchParams = {
      type: OUTBOUND_RECORD,
      activeStockId,
      stockListByDelivery,
      searchHandle,
    };
    const tableParams = {
      columns: OUTBOUND_RECORD_COLUMNS,
      stockOrdersLog,
      pagination,
    };
    return (
...
export default connect(mapStateToProps)(OutboundRecord);
