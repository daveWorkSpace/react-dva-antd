...
import { OrderTrackEvent, StockOrdersErrorFlag, SellerOrdersErrorFlag, SellerOrdersColsedType } from '../../application/define';
...
// 运营管理 - 运单详情 - 订单明细 columns
export const OPERATIONS_DETAILS_DETAILS_INFO_COLUMNS = [{
  title: '商家名称',
  dataIndex: 'name',
  key: 'name',
}, {
