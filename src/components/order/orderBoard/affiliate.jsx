...
//引入枚举值
import { AFFILIATE } from '../core/enumerate'

const moment = require('moment');

const { rgReg, requestPagerSize, requestPageNumber } = OrderParams;

class AffiliateOrderBoard extends React.Component {
  constructor(props) {
    super();
  ...
  renderFilterComponent = () => {
    ...
    const { onChangeDate, onHandleSearch } = this;
    const props = {
      cityCode,       //当前城市code
...
module.exports = connect(mapStateToProps)(AffiliateOrderBoard);
