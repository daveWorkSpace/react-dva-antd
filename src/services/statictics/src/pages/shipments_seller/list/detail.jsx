...
import {SHIPMENTS_SELLER_LIST} from '../../../ActionsName';
...
let View = ({staticticsShipmentsSeller,dispatch}) => {
...
function mapStateToProps({staticticsShipmentsSeller}) {
  return {staticticsShipmentsSeller};
};
