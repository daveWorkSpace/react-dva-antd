...
import {SHIPMENTS_COURIER_LIST} from '../../../ActionsName';
...
let View = ({staticticsShipmentsCourier,dispatch}) => {
...
function mapStateToProps({staticticsShipmentsCourier}) {
  return {staticticsShipmentsCourier};
};
