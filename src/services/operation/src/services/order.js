...
//获取区域列表订单统计
export async function fetchSellerOrderStatistics(vendorId, sellerId, cityCode, shippingDate, isDirect) {
  const params = {
    vendor_id: vendorId,
    seller_id: sellerId,
    city_code: cityCode,
...
//获取商家订单列表
export async function fetchSellerOrderList(vendorId, cityCode, shippingDate, isDirect, page, limit, sort) {
  const params = {
    vendor_id: vendorId,
    city_code: cityCode,
    shipping_date: shippingDate,
...
//获取异常订单列表
export async function fetchCloseOrderList(params) {
